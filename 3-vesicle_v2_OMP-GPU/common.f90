module mod_common
  ...
  ! real positions on lab reference frame
  real, dimension(3*np) :: ppr
  ...
  !$omp declare target(lx, ly, lz, vol_frac, vol_box, dt, t_w0, t_w1, &
  !$omp& t_nb0, t_nb1, t_nb_tot, t_comp0, t_comp1, t_comp_tot, &
  !$omp& istep, F_elst, p_id, radii, pp, po, pv, pw, pa, pb, ppr, &
  !$omp& num_nb, nb_ind, d_ij_mx, r_ij_mx, v_ij_mx, F_stk_mx, &
  !$omp& F_rep_mx, F_lub_mx, F_col_mx, F_f_mx, fr_prev_mx, fr_curr_mx, &
  !$omp& xi_prev_mx, xi_curr_mx, F_crit, stress, F_stk_factor, T_stk_factor, &
  !$omp& masses, mois, R_xiia1, R_xiia2, R_yiia, R_yiib, R_yjib, R_yiic, R_yijc, &
  !$omp& R_yjjc, y_shift, v_shift, x_shift, u_shift, t9, iout0, iout1, iout2, iout3)
...
module mod_common_output
  ...
  real, dimension(3,3) :: s_rep, s_lub, s_ctt, s_hyd  ! repulsion-/lubrication-/contact-/hydrodynamic-force stress tensor

  !$omp declare target(l_col, l_bad, club, ccol, h_avr, h_max, F_stk_1, F_rep_1, F_lub_1, F_col_1, F_f_1, s_rep, s_lub, s_ctt, s_hyd)
